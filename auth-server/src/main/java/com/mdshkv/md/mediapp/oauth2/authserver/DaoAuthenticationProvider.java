...
public class DaoAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
	...
	protected void additionalAuthenticationChecks(UserDetails userDetails,
		...
		Object salt = null;
		System.out.println("************************DaoAuthenticationProvider **additionalAuthenticationChecks***********userDetails  "+userDetails);
		System.out.println("************************DaoAuthenticationProvider **additionalAuthenticationChecks***********saltSource  "+saltSource);
	...
	protected final UserDetails retrieveUser(String username,
		...
		System.out.println("*******************************************************************DaoAuthenticationProvider************UserDetails "+authentication);
		System.out.println("*******************************************************************DaoAuthenticationProvider************UserDetails "+authentication.getName());
		System.out.println("*******************************************************************DaoAuthenticationProvider************UserDetails "+authentication.getAuthorities());
		System.out.println("*******************************************************************DaoAuthenticationProvider************UserDetails "+authentication.getCredentials());
		System.out.println("*******************************************************************DaoAuthenticationProvider************UserDetails "+authentication.getDetails());
		System.out.println("*******************************************************************DaoAuthenticationProvider************UserDetails "+authentication.getPrincipal());
		System.out.println("*******************************************************************DaoAuthenticationProvider************UserDetails "+username);
		try {
